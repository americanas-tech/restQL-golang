...
`
	...
	mockServer.Mux().HandleFunc("/api/planets/", func(w http.ResponseWriter, r *http.Request) {
		...
		test.Equal(t, test.Unmarshal(`{ "name": "Yavin IV" }`), test.Unmarshal(body))
...
`
	...
	mockServer.Mux().HandleFunc("/api/planets/", func(w http.ResponseWriter, r *http.Request) {
		...
		test.NotEqual(t, body, "")
		test.Equal(t, test.Unmarshal(`{ "name": "Yavin IV", "population": "1500" }`), test.Unmarshal(body))
...
`
	...
	mockServer.Mux().HandleFunc("/api/planets/", func(w http.ResponseWriter, r *http.Request) {
		...
		test.NotEqual(t, body, "")
		test.Equal(t, test.Unmarshal(`{ "name": "Yavin V" }`), test.Unmarshal(body))
