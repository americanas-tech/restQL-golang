...
func loadPlugins(log *logger.Logger, location string) ([]restql.Plugin, error) {
	...
	for _, info := range fileInfos {
		if !info.IsDir() {
			...
			log.Info("start loading plugin", "plugin", info.Name())
