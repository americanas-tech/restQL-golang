...
func TestResolveChainedValues(t *testing.T) {
	tests := []struct {
		...
		doneResources                runner.Resources
	}{
		{
			...
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"id": "abcdef12345"}`)}},
		},
		{
			...
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 404}, Result: unmarshal("{}")}},
		},
		{
			"Returns a statement with EmptyChained as value if done-resource status code is not in 399 >= status >= 200",
			...
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"id": domain.Chain{"done-resource", "id"}}}},
			runner.Resources{"done-resource": runner.DoneRequests{runner.DoneRequest{Details: runner.Details{Status: 404}, Result: unmarshal("{}")}, runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"id": "abcdef"}`)}}},
		},
		{
			...
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"id": domain.Chain{"done-resource", "id"}}}},
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"id": "abcdef"}`)}},
		},
		{
			"Returns a statement with single done resource value",
			...
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{ "id": 1}`)}},
		},
		{
			"Returns a statement with single done resource value",
			...
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"name":["12354-5656"]}`)}},
		},
		{
			...
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"id": domain.Chain{"done-resource", "id"}}}},
			runner.Resources{"done-resource": runner.DoneRequests{
				runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"id": 1}`)},
				runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"id": 2}`)},
			}},
		},
		{
			...
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"id": [1,2]}`)}},
		},
		{
			...
			runner.Resources{"done-resource": runner.DoneRequest{
				Details: runner.Details{Status: 200},
		...
		},
		{
			...
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"id": domain.Chain{"done-resource", "sidekickId"}}}},
			runner.Resources{"done-resource": runner.DoneRequests{
				runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`[{"id":"A","sidekickId":[1,2]},{"id":"B","sidekickId":[3,4]}]`)},
			}},
		},
		{
			"Returns a statement with single list value",
			...
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"id": domain.Chain{"done-resource", "id"}, "name": []interface{}{"a", "b"}}}},
			runner.Resources{"done-resource": runner.DoneRequests{
				runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"id":1,"class":"rest"}`)},
				runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"id":null,"class":"rest"}`)},
			}},
		},
		{
			...
			runner.Resources{"done-resource": runner.DoneRequests{
				runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"id":1,"class":"rest"}`)},
				runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"class":"rest"}`)}}},
		},
		{
			...
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"language":{"id":["clojure","java"]}}`)}},
		},
		{
			"Resolve a statement with lists and nested values",
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"name": "clojure"}}},
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"name": domain.Chain{"done-resource", "language", "id"}}}},
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"language":{"id":"clojure"}}`)}},
		},
		{
			"Resolve a statement with lists and nested values",
		...
		},
		{
			...
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"name": []interface{}{"clojure", "java"}}}},
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"name": domain.Chain{"done-resource", "language", "id"}}}},
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"language":[{"id":"clojure"},{"id":"java"}]}`)}},
		},
		{
			"Resolve a statement with lists and nested values",
			...
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"language":[{"xpto":{"id":"python"}},{"xpto":{"id":"elixir"}}]}`)}},
		},
		{
			"Resolve a statement with lists and nested values",
			...
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"name": domain.Chain{"done-resource", "language", "xpto", "id"}}}},
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"language":[{"xpto":{"id":["python","123"]}},{"xpto":{"id":["elixir","345"]}}]}`)}},
		},
		{
			"Resolve a statement with lists and nested values",
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"name": []interface{}{[]interface{}{"python", "123"}, []interface{}{"elixir", "345"}}}}},
			...
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"language":[{"xpto":{"asdf":[{"id":"python"},{"id":"123"}]}},{"xpto":{"asdf":[{"id":"elixir"},{"id":"345"}]}}]}`)}},
		},
		{
			"Resolve a statement with lists and nested values",
			...
			runner.Resources{
				"done-resource": runner.DoneRequests{
					runner.DoneRequests{
						runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"name":"1", "weapons":["DAGGER"]}`)},
						runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"name":"2","weapons":["GUN"]}`)},
					},
					runner.DoneRequests{
						runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"name":"3", "weapons":["SWORD"]}`)},
						runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"name":"4","weapons":["SHOTGUN"]}`)},
					},
				},
			},
		},
		{
			...
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"heroes":[{"weapons":{"type":{"class":"melee"}}}]}`)}},
		},
		{
			"Returns a statement with chained param inside list",
		...
		},
		{
			...
			runner.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{"weapon-class": []interface{}{domain.Chain{"done-resource", "heroes", "weapons", "type", "class"}}}}},
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"heroes":[]}`)}},
		},
		{
			...
			runner.Resources{"done-resource": runner.DoneRequest{Details: runner.Details{Status: 200}, Result: unmarshal(`{"hero": {"origin": "USA"}}`)}},
		},
	}
