...
func TestResolveChainedValues(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 404, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal("{}"))}},
		},
		{
			"Returns a statement with EmptyChained as value if done-resource status code is not in 399 >= status >= 200",
			...
			domain.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{Values: map[string]interface{}{"id": domain.Chain{"done-resource", "id"}}}}},
			domain.Resources{"done-resource": restql.DoneResources{restql.DoneResource{Status: 404, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal("{}"))}, restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"id": "abcdef"}`))}}},
		},
		{
			...
			domain.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{Values: map[string]interface{}{"id": domain.Chain{"done-resource", "id"}}}}},
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"id": "abcdef"}`))}},
		},
		{
			"Returns a statement with single done resource value",
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{ "id": 1}`))}},
		},
		{
			"Returns a statement with single done resource value",
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"name":["12354-5656"]}`))}},
		},
		{
			...
			domain.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{Values: map[string]interface{}{"id": domain.Chain{"done-resource", "id"}}}}},
			domain.Resources{"done-resource": restql.DoneResources{
				restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"id": 1}`))},
				restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"id": 2}`))},
			}},
		},
		{
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"id": [1,2]}`))}},
		},
		{
			...
			domain.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{Values: map[string]interface{}{"id": domain.Chain{"done-resource", "id"}, "name": []interface{}{"a", "b"}}}}},
			domain.Resources{"done-resource": restql.DoneResources{
				restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"id":1,"class":"rest"}`))},
				restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"id":null,"class":"rest"}`))},
			}},
		},
		{
			...
			domain.Resources{"done-resource": restql.DoneResource{
				Status:       200,
				ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`[{"id":"A","sidekickId":[1,2]},{"id":"B","sidekickId":[3,4]}]`)),
			}},
		},
		{
			"Returns a statement with multiple list value",
			...
			domain.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{Values: map[string]interface{}{"id": domain.Chain{"done-resource", "sidekickId"}}}}},
			domain.Resources{"done-resource": restql.DoneResources{
				restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`[{"id":"A","sidekickId":[1,2]},{"id":"B","sidekickId":[3,4]}]`))},
			}},
		},
		{
			...
			domain.Resources{"done-resource": restql.DoneResources{
				restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"id":1,"class":"rest"}`))},
				restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"class":"rest"}`))},
			}},
		},
		{
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"language":{"id":["clojure","java"]}}`))}},
		},
		{
			"Resolve a statement with lists and nested values",
			...
			domain.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{Values: map[string]interface{}{"name": domain.Chain{"done-resource", "language", "id"}}}}},
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"language":{"id":"clojure"}}`))}},
		},
		{
			"Resolve a statement with lists and nested values",
		...
		},
		{
			...
			domain.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{Values: map[string]interface{}{"name": []interface{}{"clojure", "java"}}}}},
			domain.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{Values: map[string]interface{}{"name": domain.Chain{"done-resource", "language", "id"}}}}},
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(
				test.NoOpLogger,
				test.Unmarshal(`{"language":[{"id":"clojure"},{"id":"java"}]}`),
			)}},
		},
		{
			"Resolve a statement with lists and nested values",
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(
				test.NoOpLogger,
				test.Unmarshal(`{"language":[{"xpto":{"id":"python"}},{"xpto":{"id":"elixir"}}]}`),
			)}},
		},
		{
			"Resolve a statement with lists and nested values",
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(
				test.NoOpLogger,
				test.Unmarshal(`{"language":[{"xpto":{"id":["python","123"]}},{"xpto":{"id":["elixir","345"]}}]}`),
			)}},
		},
		{
			"Resolve a statement with lists and nested values",
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(
				test.NoOpLogger,
				test.Unmarshal(`{"language":[{"xpto":{"asdf":[{"id":"python"},{"id":"123"}]}},{"xpto":{"asdf":[{"id":"elixir"},{"id":"345"}]}}]}`),
			)}},
		},
		{
			"Resolve a statement with lists and nested values",
			...
			domain.Resources{
				"done-resource": restql.DoneResources{
					restql.DoneResources{
						restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"name":"1", "weapons":["DAGGER"]}`))},
						restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"name":"2","weapons":["GUN"]}`))},
					},
					restql.DoneResources{
						restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"name":"3", "weapons":["SWORD"]}`))},
						restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"name":"4","weapons":["SHOTGUN"]}`))},
					},
				},
			},
		},
		{
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"heroes":[{"weapons":{"type":{"class":"melee"}}}]}`))}},
		},
		{
			"Returns a statement with chained param inside list",
		...
		},
		{
			...
			domain.Resources{"resource-name": domain.Statement{Resource: "resource-name", With: domain.Params{Values: map[string]interface{}{"weapon-class": []interface{}{domain.Chain{"done-resource", "heroes", "weapons", "type", "class"}}}}}},
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"heroes":[]}`))}},
		},
		{
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"hero": {"origin": "USA"}}`))}},
		},
		{
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"id": ["abcdef", "12345"]}`))}},
		},
		{
		...
		},
		{
			...
			domain.Resources{"done-resource": restql.DoneResource{Status: 200, ResponseBody: restql.NewResponseBodyFromValue(test.NoOpLogger, test.Unmarshal(`{"tokens": ["abcdef","ghijkl"]}`))}},
		},
		{
